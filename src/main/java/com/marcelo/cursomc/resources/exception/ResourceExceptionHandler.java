...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandartError> objectNotFoundO(ObjectNotFoundException e, HttpServletRequest request) {
    ...
    public ResponseEntity<ValidationError> validatationException(MethodArgumentNotValidException e, HttpServletRequest request) {
